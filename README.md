...
Example app showing integration of [Percy](https://percy.io/) visual testing into Protractor tests.
...
by opening the
[`index.html`](https://github.com/percy/example-percy-protractor/blob/master/index.html)
file in a browser.
...
This will run the app's Protractor tests, which contain calls to create Percy snapshots. The snapshots
